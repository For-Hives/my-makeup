        ...
        <>
            <footer className={"mt-52 w-full bg-white flex mx-auto max-w-7xl gap-20"}>
                <div className={"flex flex-col gap-6"}>
                    <div className={"flex justify-start items-center gap-3"}>
                        ...
                        <h4 className={"text-2xl font-bold text-my-makeup-900"}>My Makeup</h4>
                    </div>
                ...
                <div className={"flex flex-col gap-6"}>
                    ...
                    <a href={"/particulier/trouver-une-maquilleuse"} className={"text-sm text-slate-600"}>
                        Trouver des maquilleuses
                    </a>
                    <a href={"/particulier/centraliser-ses-recherches"} className={"text-sm text-slate-600"}>
                        Centraliser ses recherches
                    </a>
                    <a href={"/particulier/explorer-les-profils"} className={"text-sm text-slate-600"}>
                ...
                <div className={"flex flex-col gap-6"}>
                    ...
                    <a href={"/maquilleuse/partenariats"} className={"text-sm text-slate-600"}>
                        Community & Partenariats
                    </a>
                    <a href={"/maquilleuse/partenaires"} className={"text-sm text-slate-600"}>
                        Nos partenaires
                    </a>
                ...
                <div className={"flex flex-col gap-6"}>
                    ...
                    <a href={"/solutions/pour-les-particuliers"} className={"text-sm text-slate-600"}>
                        Solution pour les particuliers
                    </a>
                    <a href={"/solutions/pour-les-maquilleuses"} className={"text-sm text-slate-600"}>
                ...
                <div className={"flex flex-col gap-6"}>
                    ...
                    <a href={"/politique-confidentialite"} className={"text-sm text-slate-600"}>
            ...
            <div className={"py-20 w-full bg-white flex mx-auto max-w-7xl"}>
                <p className={"text-sm text-slate-600 mx-auto"}>
                    © {year} My Makeup - Tous droits réservés - Developed with ❤️ by <a className={"text-sm text-slate-600"} href={"https://andy-cinquin.fr"}>Andy Cinquin</a>
                </p>
            </div>
        </>
    );
