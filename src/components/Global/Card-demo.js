...
function CardDemo(props) {
	return (
		<div
			className={
				'w-[200px] h-auto relative bg-white rounded-xl flex gap-2 flex-col pb-4 shadow-2xl'
			}
		>
			...
			<div
				className={'absolute ml-3 mt-[135px] flex justify-center items-center'}
			>
				<div
					className={
						'bg-white shadow rounded-lg w-full px-3 text-center ' +
			...
			{/*    Square */}
			<div
				className={'w-full px-4 flex justify-center items-center gap-1 mt-4'}
			>
