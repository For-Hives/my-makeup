...
function CardDemo(props) {
    return (<div className={"w-[200px] h-auto relative bg-white rounded-xl flex gap-2 flex-col pb-4 shadow-2xl"}>
        ...
        {/* if heart is true */}
        {props.heart ? (<div className={"absolute top-0 right-0 flex justify-center items-center"}>
            <HeartIcon className={"h-6 w-6 text-red-600 mr-2 mt-2"}/>
        </div>) : null}
        <div className={"absolute ml-3 mt-[135px] flex justify-center items-center"}>
            <div className={"bg-white shadow rounded-lg w-full px-3 text-center " + "flex items-center justify-center text-xs font-medium italic text-indigo-900/90 py-1"}>
