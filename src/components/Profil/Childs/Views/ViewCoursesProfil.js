...
function ViewCoursesProfil(props) {
	...
	return (
		<div className={'flex w-full flex-col gap-4'}>
			<h2 className={'text-xl font-bold text-gray-700'}>Formations & diplomes</h2>
			{user?.courses &&
						...
						<div key={index} className={'flex text-gray-700'}>
							...
							<div className={'ml-2 flex w-full flex-col gap-2'}>
								<div className={'flex flex-col'}>
									<p className={'font-semibold text-gray-700'} data-cy={'course-diploma'}>
										{course?.diploma}
									</p>
									<div className={'flex w-full justify-between'}>
										<p className={'text-sm italic text-gray-600'} data-cy={'course-school'}>
											{course?.school}
										</p>
										<p className={'text-sm italic text-gray-600'} data-cy={'course-date-graduation'}>
