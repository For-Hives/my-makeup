...
export function LanguageProfil(props) {
	...
	return (
		<div className={'relative w-full'}>
			<ModalUpdateLanguageProfil isModalOpen={isModalOpen} handleUpdateUser={props.handleUpdateUser} handleIsModalOpen={handleIsModalOpen} user={user} />
				...
				{!isPublic ? (
					...
					>
						<div className={'btn-alt-primary flex items-center gap-3 bg-white text-indigo-900'}>
							...
							<span className={'font-semibold'}>Modifier vos langues parlées</span>
						</div>
					</button>
				) : null}
