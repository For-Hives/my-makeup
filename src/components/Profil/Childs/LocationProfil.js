...
export function LocationProfil(props) {
	...
	return (
		<div className={'w-full'}>
			<ModalUpdateLocationProfil isModalOpen={isModalOpen} handleUpdateUser={props.handleUpdateUser} handleIsModalOpen={handleIsModalOpen} user={user} />
				...
				{!isPublic ? (
					...
					>
						<div className={'btn-alt-primary flex items-center gap-3 bg-white text-indigo-900'}>
							...
							<span className={'font-semibold'}>Modifier vos informations de localisation</span>
						</div>
					</button>
				) : null}
