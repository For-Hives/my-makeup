        ...
        <div className="mx-auto max-w-7xl">
            <div className="mx-auto flex w-full gap-24">
                ...
                <div className={"w-4/5 grid grid-cols-4 gap-8"}>
                    {TalentList.map((talent, index) => (<a key={talent.name} href={"/" + talent.name} className={"group relative"}>
                        ...
                        <h2 className={"absolute top-0 left-0 h-full w-full transition ease-in duration-100 py-8 px-4 border border-indigo-900 bg-indigo-900 " + "rounded-xl flex items-center justify-center font-semibold text-slate-50 opacity-0 -z-10 group-hover:opacity-100 group-hover:z-10 text-center"}>
