    ...
    return (<section className={"relative py-20 flex flex-col gap-10"}>
        ...
        <div className="mx-auto max-w-7xl mt-20">
            <div className="mx-auto flex w-full gap-16">
                <div className={"w-2/5 flex flex-col justify-center items-start relative gap-8"}>
                ...
                <div className={"w-3/5 flex justify-center items-center"}>
                    <div className={"ml-32 flex justify-center items-center w-full relative h-full"}>
                        <Image className={"object-cover rounded-xl"} src={"/assets/maquilleuse_mariage.webp"} fill={"cover"} alt={"Maquilleuse pour un mariage"}/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl mt-20">
            <div className="mx-auto flex w-full gap-16">
                <div className={"w-2/5 flex flex-col justify-center items-start relative gap-8"}>
                    ...
                    <div className={"flex flex-col gap-4"}>
                        <p>
                            Avec de nombreuses maquilleuses freelances talentueuses disponibles sur notre plateforme,
                            trouvez rapidement la maquilleuse professionnelle qui répond à tous
                            vos besoins.
                            Recherchez parmi les meilleurs profils disponibles pour votre projet,
                            consultez leurs avis et expériences, et discutez directement avec eux
                            pour les recruter en quelques clics.
                        </p>
                        <p>
                            Trouvez votre experte en maquillage pour les mariées, une maquilleuse artistique, professionnelle
                            ou spécialisée en maquillage yeux ou en maquillage de
                            soirée. Besoin d&apos;une maquilleuse fx pour un projet cinéma ou d&apos;une
                            maquilleuse événementielle pour une soirée spéciale ? Nous avons ce qu&apos;il vous faut !
                        </p>
                        <p>
                            Nous sommes là pour faciliter votre recherche de maquilleuse freelance.
                            Une fois que vous avez trouvé la bonne personne,
                            nous nous occupons du reste. Alors n&apos;attendez plus, rejoignez My Makeup dès maintenant et
                            trouvez votre maquilleuse de rêve en quelques clics !
                        </p>
                    </div>
                    <div className={"flex"}>
        ...
        <div className="mx-auto max-w-7xl mt-20">
            <div className="mx-auto flex w-full">
                ...
                <div className={"w-2/5 flex flex-col justify-center items-start h-auto relative gap-8"}>
                    ...
                    <div className={"flex flex-col gap-4"}>
                        <p>
                            Que vous cherchiez une maquilleuse pour les mariées, une maquilleuse artistique ou une
                            maquilleuse spécialisée en maquillage yeux, nous avons tout ce qu&apos;il
                            vous faut. Trouvez facilement des maquilleuses expérimentées disponibles à
                            Lyon, Nantes, Toulouse, Rennes, Lille, Cannes ou Paris, pour un maquillage
                            professionnel ou un maquillage de soirée.
                        </p>
                        <p>
                            Avec My Makeup, vous pouvez également trouver des maquilleuses fx pour vos
                            projets cinéma ou des maquilleuses événementielles pour vos soirées spéciales.
                            Besoin d&apos;une maquilleuse à domicile ou pour un anniversaire ? Nous avons également des profils adaptés à vos besoins.
                        </p>
                        <p>
                            Notre solution de gestion est simple et intuitive, même pour les débutants.
                            Avec My Makeup, vous pouvez centraliser toutes vos activités avec les
                            maquilleuses professionnelles de votre choix, pour une gestion simplifiée.
                        </p>
                        <p>
                            Alors n&apos;hésitez plus, inscrivez-vous dès maintenant sur My Makeup et simplifiez la
                            gestion de vos activités avec vos maquilleuses professionnelles préférées !
                        </p>
                    </div>
                    <div className={"flex"}>
                        <a href="/recrutement" className={"text-sm font-bold leading-6 bg-indigo-900 text-white px-4 py-2 rounded-lg border-2 border-indigo-900"}>
