		...
		<section className={'relative px-4 py-20 md:px-0'}>
			<div className="mx-auto max-w-7xl">
				<div className="mx-auto">
					<h2 className="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl">My-Makeup c&apos;est avant tout une communauté</h2>
			...
			<div className={'mx-auto mt-10 max-w-7xl'}>
				<div className={'mx-auto flex flex-col items-center justify-center gap-16 md:flex-row lg:gap-32'}>
					<div className={'flex flex-col items-center justify-center gap-2'}>
						<Image alt={'client à la recherche de maquilleuse'} src={'/assets/illustrations/illustration.webp'} width={'140'} height={'140'} />
						<h3 className={'text-center text-4xl font-bold tracking-tight text-gray-700 sm:text-xl'}>Des milliers de particuliers</h3>
						<p className={'text-center text-sm leading-8 text-gray-600'}>À la recherche de maquilleuses expérimentées</p>
					</div>
					<div className={'flex flex-col items-center justify-center gap-2'}>
						<Image
							...
							height={'140'}
						/>
						<h3 className={'text-center text-4xl font-bold tracking-tight text-gray-700 sm:text-xl'}>Des milliers de maquilleuses</h3>
					...
					<div className={'flex flex-col items-center justify-center gap-2'}>
						<Image
							...
							height={'140'}
						/>
						<h3 className={'text-center text-4xl font-bold tracking-tight text-gray-700 sm:text-xl'}>Une solution dédiée</h3>
