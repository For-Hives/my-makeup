						...
						<div className="mx-auto max-w-2xl">
							<article>
								...
								<div className="prose my-8 xl:prose-lg">
									<p>
										Que vous prépariez votre mariage, un événement spécial ou
										que vous souhaitiez simplement vous offrir une session de
										maquillage professionnel, le choix de la bonne maquilleuse
										est essentiel pour obtenir le look que vous désirez. Mais
										avec un si grand nombre de professionnels disponibles,
										comment faire le bon choix ? Ce guide vous aidera à naviguer
										parmi les profils disponibles et à trouver la maquilleuse
