						...
						<article>
							...
							<div className="prose my-8 xl:prose-lg">
								...
								<p>
									...
									contacter à l{"'"}adresse suivante : contact@my-makeup.fr Nous
									vous remercions de votre confiance et nous nous engageons à
									protéger la confidentialité de vos informations personnelles
