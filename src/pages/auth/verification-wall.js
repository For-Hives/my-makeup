	...
	return (
		<>
			<Head>
				...
				<meta name="description" content="Processus de vérification de profil, sur My-Makeup, la plateforme pour les maquilleuses !" />
				{/*	seo tag canonical link */}
				<link rel="canonical" href="https://my-makeup.fr/auth/verification-wall" />
			</Head>
			<div className="relative flex h-[95vh] max-h-screen overflow-hidden md:h-screen md:overflow-auto md:bg-white">
				<div className="flex flex-1 flex-col justify-center bg-white px-4 sm:px-6 md:py-12 md:pt-12 lg:flex-none lg:px-20 xl:px-24">
					<div className="mx-auto w-full max-w-sm lg:w-96">
						...
						<div className={'mt-8'}>
							<h1 className={'my-8 text-2xl font-semibold text-gray-900'}>Veuillez vérifier votre adresse email My-Makeup</h1>
