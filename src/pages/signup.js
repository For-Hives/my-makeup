...
function Signup() {
    return (<>
        <Head>
            ...
            <meta name="description" content="Inscription sur my-makeup.fr la plateforme qui va révolutionner votre
        ...
        <div className="flex min-h-screen bg-">
                                ...
                                <div className="mt-2 grid grid-cols-3 gap-3">
                                    ...
                                    <div>
                                        <a
                                            ...
                                            className="inline-flex w-full justify-center rounded-md bg-white py-2 px-3 text-gray-500 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0"
                                        >
                                            <span className="sr-only">Se connecter via instagram</span>
                                            <svg className="h-5 w-5" aria-hidden="true" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            <svg className="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                                                <g id="OUTLINE_copy_2">
                                                    <g>
                                                        <path
                                                            d="m16 0c-8.837 0-16 7.164-16 16s7.163 16 16 16c8.836 0 16-7.164 16-16s-7.163-16-16-16zm.173 24.596c-4.749 0-8.596-3.847-8.596-8.596s3.847-8.596 8.596-8.596c2.321 0 4.261.855 5.748 2.24l-2.423 2.423v-.005c-.902-.86-2.047-1.3-3.325-1.3-2.836 0-5.141 2.396-5.141 5.232s2.305 5.238 5.141 5.238c2.573 0 4.325-1.472 4.685-3.492h-4.685v-3.353h8.085c.107.574.166 1.177.166 1.805 0 4.912-3.288 8.404-8.251 8.404z"/>
                                                    </g>
                                                </g>
                                            </svg>
                                        </a>
                        ...
                        <div className="mt-6">
                            <form action="#" method="POST" className="space-y-6">
                                ...
                                <div className="flex items-center justify-end">
                                    <p className={"text-xs"}>
                                        En vous inscrivant sur My-Makeup vous confirmez que vous acceptez les conditions générales.
                                    </p>
                                </div>
                                <div>
                                    <button
            ...
            <div className="relative hidden w-full flex-1 lg:block lg:object-contain">
                <div className={"w-full h-full bg-gradient-to-r from-white via-transparent to-transparent absolute top-0 left-0 z-20"}>

                </div>
                <Image alt={"background my-makeup"}
                       fill
