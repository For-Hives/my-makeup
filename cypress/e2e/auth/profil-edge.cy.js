																								...
																								.then(() => {
																									...
																									cy.get("[data-cy='profil-public-view']")
																										...
																										.then(() => {
																											...
																											cy.get("[data-cy='service-offer-button-0']")
																												.click({ force: true })
																												.then(() => {
																													cy.get("[data-cy='service-offer-button-1']")
																														.click({ force: true })
																														.then(() => {
																															cy.get("[data-cy='service-offer-button-2']")
																																.click({ force: true })
																																.then(() => {
																																	// 	service offers
																																	cy.get("[data-cy='service-offer-name']").should('contain', 'Maquillage Modified')
																																	cy.get("[data-cy='service-offer-description']").should(
																																		'contain',
																																	...
																																	cy.get("[data-cy='service-offer-description-0']").should(
																																		'contain',
																																	...
																																	cy.get("[data-cy='service-offer-description-1']").should(
																																		'contain',
																																	...
																																	cy.get("[data-cy='service-offer-description-2']").should(
																																		'contain',
