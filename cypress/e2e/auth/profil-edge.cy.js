							...
							.then(() => {
								...
								cy.wait('@patchMeMakeup')
									...
									.then(() => {
										...
										cy.get("[data-cy='profil-public-view']")
											.click()
											.then(() => {
												cy.wait(1000)

												// first and lastname check
												cy.get("[data-cy='resume-name']").should(
													'contain',
													'Utilisateur DE TEST'
												)
												// 	resume-speciality
												cy.get("[data-cy='resume-speciality']").should(
													'contain',
													'Maquilleur professionnel et coiffeur professionnel pour le cinéma'
												)
												// 	resume-company-artist-name
												cy.get("[data-cy='resume-company-artist-name']").should(
													'contain',
													'My Makeup Artist'
												)
											})
													...
													.then(() => {
														...
														cy.get("[data-cy='profil-public-view']")
															...
															.then(() => {
																...
																cy.get(
																	"[data-cy='resume-city-action-radius']"
																).should(
																	'contain',
																...
																).should('contain', 'Nantes & 5km autour')
															})
													})
											})
									})
																		...
																		.then(() => {
																			...
																			cy.get("[data-cy='profil-public-view']")
																				...
																				.then(() => {
																					...
																					).should('contain', 'EpsiModified')
																					cy.get(
																						"[data-cy='course-school']"
																					).should('contain', 'epsiModified')
																					cy.get(
																						"[data-cy='course-date-graduation']"
																					).should('contain', '2022-10-10')
																					cy.get(
								...
								.then(() => {
									...
									cy.get("[data-cy='profil-public-view']")
										...
										.then(() => {
											...
											// 	Languages
											cy.get("[data-cy='language']").should(
												'contain',
												'Anglais'
											)
										})
															...
															.then(() => {
																...
																cy.get("[data-cy='profil-public-view']")
																	...
																	.then(() => {
																		...
																		cy.get("[data-cy='facebook']").should(
																			'contain',
																			'https://facebook.com'
																		)
			...
			cy.visit('http://localhost:3000/auth/profil').then(() => {
				...
				cy.get("[data-cy='update-service-offers-button']")
					...
					.then(() => {
						cy.get('body').then($body => {
							if (
								$body.find("[data-cy='delete-service-offers-button']").length >
								0
							) {
								cy.get("[data-cy='delete-service-offers-button']").then(
									$elems => {
										const deleteButtonsCount = $elems.length

										for (let i = 0; i < deleteButtonsCount; i++) {
											cy.get("[data-cy='delete-service-offers-button']")
												.first()
												.click()
										}
									}
																								...
																								.then(() => {
																									...
																									cy.get(
																										...
																										.then(() => {
																											...
																											cy.get(
																												"[data-cy='service-offer-button-0']"
																											)
																												.click({ force: true })
																												.then(() => {
																													cy.get(
																														"[data-cy='service-offer-button-1']"
																													)
																														.click({
																															force: true,
																														})
																														.then(() => {
																															cy.get(
																																"[data-cy='service-offer-button-2']"
																															)
																																.click({
																																	force: true,
																																})
																																.then(() => {
																																	...
																																	cy.get(
																																		"[data-cy='service-offer-description']"
																																	).should(
																																		'contain',
																																		'Maquillage de soirée Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-price']"
																																	).should(
																																		'contain',
																																		'50€ Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-name-0']"
																																	).should(
																																		'contain',
																																		'Maquillage 1 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-description-0']"
																																	).should(
																																		'contain',
																																		'Maquillage de soirée 1 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-price-0']"
																																	).should(
																																		'contain',
																																		'50€ 1 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-name-1']"
																																	).should(
																																		'contain',
																																		'Maquillage 2 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-description-1']"
																																	).should(
																																		'contain',
																																		'Maquillage de soirée 2 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-price-1']"
																																	).should(
																																		'contain',
																																		'50€ 2 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-name-2']"
																																	).should(
																																		'contain',
																																		'Maquillage 3 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-description-2']"
																																	).should(
																																		'contain',
																																		'Maquillage de soirée 3 Modified'
																																	)
																																	cy.get(
																																		"[data-cy='service-offer-price-2']"
																																	).should(
																																		'contain',
																																		'50€ 3 Modified'
																																	)
	...
	describe('Portefolio - section - (min, max, required)', () => {
		it('tests complet Portefolio - section', () => {
			...
			cy.visit('http://localhost:3000/auth/profil').then(() => {
				...
				// 001-bathing.webp
				cy.fixture('./assets/001-bathing.webp', { encoding: null }).as(
					'pictureCat1'
				)
				// 002-photograph.webp
				cy.fixture('./assets/002-photograph.webp', { encoding: null }).as(
					'pictureCat2'
				)
				// 003-message.webp
				cy.fixture('./assets/003-message.webp', { encoding: null }).as(
					'pictureCat3'
				)
				// 004-family.webp
				cy.fixture('./assets/004-family.webp', { encoding: null }).as(
					'pictureCat4'
				)
				// 005-father and son.webp
				cy.fixture('./assets/005-father and son.webp', { encoding: null }).as(
					'pictureCat5'
				)
				// 006-family.webp
				cy.fixture('./assets/006-family.webp', { encoding: null }).as(
					'pictureCat6'
				)
				// 007-bubbles.webp
				cy.fixture('./assets/007-bubbles.webp', { encoding: null }).as(
					'pictureCat7'
				)
				// 008-ice cream.webp
				cy.fixture('./assets/008-ice cream.webp', { encoding: null }).as(
					'pictureCat8'
				)
				// 009-reading.webp
				cy.fixture('./assets/009-reading.webp', { encoding: null }).as(
					'pictureCat9'
				)
				// 010-sleeping.webp
				cy.fixture('./assets/010-sleeping.webp', { encoding: null }).as(
					'pictureCat10'
				)
				// 011-family.webp
				cy.fixture('./assets/011-family.webp', { encoding: null }).as(
					'pictureCat11'
				)
																												...
																												cy.get(
																													...
																													.then(() => {
																														...
																														cy.get(
																															...
																															'contain',
																															'La limite du nombre de photos est atteinte.'
																														)
